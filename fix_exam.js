            ...
            <div class="question-block">
                ...
                <div class="solution">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6"><strong data-i18n="q1d">(d) 2 進位的 2 補數：</strong><br><span data-i18n="q1d_desc">1 補數 + 1：</span>\\mathbf{011011}</div>
                    </div>
                    <div class="row mt-3">
...
fs.appendFileSync(path, `
            ...
            <div class="question-block">
                ...
                <div class="solution">
                    ...
                    <svg class="kmap-svg" width="350" height="200" viewBox="0 0 350 200">
                        ...
                        <text x="40" y="30">A\\BC</text><text x="100" y="30">00</text><text x="160" y="30">01</text><text x="220" y="30">11</text><text x="280" y="30">10</text>
                    ...
                    <p class="font-weight-bold highlight"><span data-i18n="ans">答案：</span><br>SOP: $F = A'B' + A'C + AC'$<br>POS: $F = (A'+C')(A+B'+C)$</p>
                </div>
                <p class="mt-4" data-i18n="q4b_text">(b) $F(A,B,C,D)=\\Sigma(0,1,2,3,7,8,9,11,12)$</p>
                <div class="solution">
                    <span class="step-title" data-i18n="kmap_simplify">卡諾圖化簡 (4-variable)：</span>
                    <svg class="kmap-svg" width="400" height="300" viewBox="0 0 400 300">
                        <g stroke="#333" stroke-width="1"><line x1="80" y1="40" x2="320" y2="40" stroke-width="2"/><line x1="80" y1="90" x2="320" y2="90"/><line x1="80" y1="140" x2="320" y2="140"/><line x1="80" y1="190" x2="320" y2="190"/><line x1="80" y1="240" x2="320" y2="240" stroke-width="2"/><line x1="80" y1="40" x2="80" y2="240" stroke-width="2"/><line x1="140" y1="40" x2="140" y2="240"/><line x1="200" y1="40" x2="200" y2="240"/><line x1="260" y1="40" x2="260" y2="240"/><line x1="320" y1="40" x2="320" y2="240" stroke-width="2"/></g>
                        <text x="35" y="30">AB\\CD</text><text x="100" y="30">00</text><text x="160" y="30">01</text><text x="220" y="30">11</text><text x="280" y="30">10</text>
                        ...
                        <g class="kmap-cell-text"><text x="105" y="70">1</text><text x="165" y="70">1</text><text x="225" y="70">1</text><text x="285" y="70">1</text><text x="225" y="120">1</text><text x="105" y="170">1</text><text x="105" y="220">1</text><text x="165" y="220">1</text><text x="225" y="220">1</text></g>
                    </svg>
                    <p class="font-weight-bold highlight"><span data-i18n="ans">答案：</span><br>SOP: $F = A'B' + A'CD + AC'D' + AB'D$</p>
                </div>
                ...
                <div class="solution">
                    ...
                    <div style="overflow-x: auto;">
                        <svg width="850" height="350" viewBox="0 0 850 350">
                            ...
                            <rect x="145" y="65" width="110" height="40" rx="10" class="hl-teal"/><rect x="205" y="115" width="110" height="90" rx="10" class="hl-blue"/><rect x="85" y="215" width="110" height="40" rx="10" class="hl-orange"/><rect x="148" y="68" width="44" height="34" rx="5" class="hl-purple" fill="none" stroke-width="3"/><rect x="148" y="218" width="44" height="34" rx="5" class="hl-purple" fill="none" stroke-width="3"/>
                    ...
                    <p class="font-weight-bold highlight mt-3"><span data-i18n="ans">答案：</span><br>SOP: $F = A'B'C'E + A'CD + BC'D' + AB'C'E' + AD'E' + C'D'E$</p>
                </div>
            </div>
`);
fs.appendFileSync(path, `
            ...
            <div class="question-block">
                ...
                <div class="solution">
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-6 border-right"><h6>(a) NAND-NAND</h6><svg width="250" height="150" class="circuit-svg"><text x="10" y="35" class="lbl">y</text><path d="M 25,30 L 70,30 L 70,20" class="wire"/><path d="M 25,30 L 70,30 L 70,40" class="wire"/><use href="#gate-nand" x="70" y="10"/><path d="M 124,30 L 150,30 L 150,60 L 170,60" class="wire"/><text x="10" y="95" class="lbl">x</text><text x="10" y="115" class="lbl">z'</text><use href="#gate-nand" x="70" y="80"/><path d="M 124,100 L 150,100 L 150,80 L 170,80" class="wire"/><use href="#gate-nand" x="170" y="50"/><text x="245" y="75" class="out">F</text></svg></div>
            ...
            <div class="question-block">
                ...
                <div class="solution">
                    ...
                    <div class="row">
                        <div class="col-md-5 border-right"><h6 class="text-center">Generator G</h6><svg width="300" height="150" class="circuit-svg"><text x="10" y="35" class="lbl">A₃</text><text x="10" y="55" class="lbl">A₂</text><use href="#gate-xor" x="70" y="20"/><path d="M115,40 L160,70" class="wire"/><text x="10" y="95" class="lbl">A₁</text><use href="#gate-xor" x="160" y="60"/><path d="M205,80 L250,110" class="wire"/><text x="10" y="135" class="lbl">A₀</text><use href="#gate-xor" x="250" y="100"/><text x="325" y="125" class="out">G</text></svg></div>
                        <div class="col-md-7"><h6 class="text-center">Checker C</h6><svg width="350" height="200" class="circuit-svg"><text x="10" y="35" class="lbl">A₃</text><text x="10" y="55" class="lbl">A₂</text><use href="#gate-xor" x="70" y="20"/><path d="M115,40 L160,70" class="wire"/><text x="10" y="95" class="lbl">A₁</text><text x="10" y="115" class="lbl">A₀</text><use href="#gate-xor" x="160" y="80"/><path d="M205,100 L250,130" class="wire"/><text x="10" y="175" class="lbl">G</text><use href="#gate-xor" x="250" y="140"/><text x="325" y="165" class="out">C</text></svg></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        window.pageTranslations = {
            'zh-TW': {
                ...
                'kmap5_desc': '五變數卡諾圖拆分為 $A=0$ 與 $A=1$ 兩層平面，需同時觀察上下兩層的相鄰性。<br>橘色群：$m_8, m_9$ (下層) 疊加 $m_{24}, m_{25}$ (上層) $\\rightarrow BC\\\'D\\\'$；紫色群：$m_1, m_9$ (下層) 疊加 $m_{17}, m_{25}$ (上層) $\\rightarrow C\\\'D\\\'E$',
            ...
            'en': {
                ...
                'kmap5_desc': '5-var K-Map split into $A=0$ and $A=1$ planes. Observe adjacencies across layers.',
